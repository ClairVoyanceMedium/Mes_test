...
@F3.f("content_update.html")
@F3.a(C2541R.integer.ic_provider_edit)
@F3.i(C2541R.string.stmt_content_update_title)
@F3.h(C2541R.string.stmt_content_update_summary)
@F3.e(C2541R.layout.stmt_content_update_edit)
...
public final class ContentUpdate extends Action implements AsyncStatement {
    ...
    public static final class a extends AbstractRunnableC1694v2 {
        ...
        public final Uri f16492L1;

        /* renamed from: M1, reason: collision with root package name */
        public final String f16493M1;

        /* renamed from: N1, reason: collision with root package name */
        public final String[] f16494N1;

        /* renamed from: O1, reason: collision with root package name */
        public final ContentValues f16495O1;

        public a(Uri uri, String str, String[] strArr, ContentValues contentValues) {
            this.f16492L1 = uri;
            this.f16493M1 = str;
            this.f16494N1 = strArr;
            this.f16495O1 = contentValues;
        }

        @Override // com.llamalab.automate.AbstractRunnableC1694v2
        public final void x2() {
            q2(Double.valueOf(this.f15400Y.getContentResolver().update(this.f16492L1, this.f16495O1, this.f16493M1, this.f16494N1)), false);
        }
    }
    ...
    public final CharSequence M1(Context context) {
        C1596k0 l8 = D1.P.l(context, C2541R.string.caption_content_update);
        l8.v(this.uri, 0);
        l8.v(this.values, 0);
        return l8.f16030c;
    }
    ...
    public final boolean r1(C1708z0 c1708z0) {
        c1708z0.q(C2541R.string.stmt_content_update_title);
