...
@F3.f("dialog_message.html")
@F3.a(C2541R.integer.ic_dialog_message)
@F3.i(C2541R.string.stmt_dialog_message_title)
@F3.h(C2541R.string.stmt_dialog_message_summary)
@F3.e(C2541R.layout.stmt_dialog_message_edit)
/* loaded from: classes.dex */
public final class DialogMessage extends ActivityAction {
    public InterfaceC1700x0 dismiss;
    ...
    public final CharSequence M1(Context context) {
        C1596k0 l8 = D1.P.l(context, C2541R.string.caption_dialog_message);
        l8.v(this.title, 0);
        l8.v(this.message, 0);
        return l8.f16030c;
    }

    @Override // com.llamalab.automate.stmt.ActivityAction, com.llamalab.automate.stmt.Action, com.llamalab.automate.stmt.AbstractStatement, R3.e
    ...
    public final void o0(R3.c cVar) {
        ...
        this.dismiss = (InterfaceC1700x0) cVar.readObject();
    }
    ...
    /* JADX WARN: Type inference failed for: r14v0, types: [android.content.Context, com.llamalab.automate.z0] */
    /* JADX WARN: Type inference failed for: r4v2, types: [android.text.Spannable, android.text.SpannableString] */
    @Override // com.llamalab.automate.A2
    public final boolean r1(C1708z0 c1708z0) {
        CharSequence charSequence;
        c1708z0.q(C2541R.string.stmt_dialog_message_title);
        Intent putExtra = new Intent((Context) c1708z0, (Class<?>) MessageDialogActivity.class).putExtra("com.llamalab.automate.intent.extra.NEGATIVE_HIDE", true);
        String x7 = J3.h.x(c1708z0, this.title, null);
        if (TextUtils.isEmpty(x7)) {
            charSequence = c1708z0.getText(C2541R.string.stmt_dialog_message_title);
        } else {
        ...
        CharSequence x9 = J3.h.x(c1708z0, this.dismiss, null);
        if (TextUtils.isEmpty(x9)) {
            x9 = c1708z0.getText(C2541R.string.action_close);
        }
        ...
        c1708z0.B(putExtra, null, s(c1708z0), r(c1708z0), c1708z0.f(C2541R.integer.ic_dialog_message), charSequence, contentText);
        return false;
    }
}
