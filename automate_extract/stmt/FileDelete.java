...
@F3.f("file_delete.html")
@F3.a(C2541R.integer.ic_storage_discard)
@F3.i(C2541R.string.stmt_file_delete_title)
@F3.h(C2541R.string.stmt_file_delete_summary)
@F3.e(C2541R.layout.stmt_file_delete_edit)
...
public final class FileDelete extends Action implements AsyncStatement {
    ...
    public final CharSequence M1(Context context) {
        C1596k0 l8 = D1.P.l(context, C2541R.string.caption_file_delete);
        l8.t(this.path);
        return l8.q(this.path).y(this.recursive, C2541R.string.caption_recursive, 0).f16030c;
    }
    ...
    public final boolean r1(C1708z0 c1708z0) {
        c1708z0.q(C2541R.string.stmt_file_delete_title);
        com.llamalab.safs.n p8 = J3.h.p(c1708z0, this.path);
        if (p8 == null) {
            throw new RequiredArgumentNullException("path");
        }
        P3.g gVar = new P3.g(p8, J3.h.f(c1708z0, this.recursive, false) ? EnumSet.of(P3.t.f5936X) : Collections.emptySet(), new Closeable[0]);
        c1708z0.w(gVar);
        gVar.w2();
        return false;
    }
