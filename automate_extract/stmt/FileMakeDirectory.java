...
@F3.f("file_make_directory.html")
@F3.a(C2541R.integer.ic_storage_folder)
@F3.i(C2541R.string.stmt_file_make_directory_title)
@F3.h(C2541R.string.stmt_file_make_directory_summary)
@F3.e(C2541R.layout.stmt_file_make_directory_edit)
...
public final class FileMakeDirectory extends Action implements AsyncStatement {
    ...
    public final CharSequence M1(Context context) {
        C1596k0 l8 = D1.P.l(context, C2541R.string.caption_file_make_directory);
        l8.t(this.path);
    ...
    public final boolean r1(C1708z0 c1708z0) {
        c1708z0.q(C2541R.string.stmt_file_make_directory_title);
        com.llamalab.safs.n p8 = J3.h.p(c1708z0, this.path);
        if (p8 == null) {
            throw new RequiredArgumentNullException("path");
        }
        P3.k kVar = new P3.k(p8, new Closeable[0]);
        c1708z0.w(kVar);
        kVar.w2();
        return false;
    }
