...
@F3.f("app_notifications_priority_get.html")
@F3.a(C2541R.integer.ic_notification_app)
@F3.i(C2541R.string.stmt_app_notifications_priority_get_title)
@F3.h(C2541R.string.stmt_app_notifications_priority_get_summary)
@F3.e(C2541R.layout.stmt_app_notifications_priority_get_edit)
/* loaded from: classes.dex */
public final class AppNotificationsPriorityGet extends Action implements AsyncStatement {
    public InterfaceC1700x0 packageName;
    public J3.l varPriority;

    public static final class a extends AbstractC1602l2 {

        /* renamed from: M1, reason: collision with root package name */
        public final String f16264M1;
        ...
        public final void w2(InterfaceC1585h1 interfaceC1585h1) {
            String str = this.f16264M1;
            try {
                int a8 = t3.o.a(this.f15400Y.getPackageManager().getApplicationInfo(str, 0).uid);
                t3.l lVar = new t3.l();
                int F7 = interfaceC1585h1.F(a8, lVar, str);
                lVar.c();
                q2(Double.valueOf(F7), false);
            } catch (Throwable th) {
                r2(th);
            }
        }
    ...
    public final CharSequence M1(Context context) {
        return D1.P.l(context, C2541R.string.caption_app_notifications_priority_get).o(0, this.packageName).q(this.packageName).f16030c;
    }
    ...
    public final void o0(R3.c cVar) {
        ...
        this.varPriority = (J3.l) cVar.readObject();
    }

    @Override // com.llamalab.automate.A2
    public final boolean r1(C1708z0 c1708z0) {
        c1708z0.q(C2541R.string.stmt_app_notifications_priority_get_title);
