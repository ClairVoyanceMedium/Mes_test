...
@F3.i(C2541R.string.stmt_app_kill_title)
@F3.h(C2541R.string.stmt_app_kill_summary)
@F3.e(C2541R.layout.stmt_app_kill_edit)
...
public final class AppKill extends PackageAction implements AsyncStatement {
    ...
    public static final class a extends AbstractC1602l2 {
        ...
        public final void w2(InterfaceC1585h1 interfaceC1585h1) {
            try {
                t3.l lVar = new t3.l();
                interfaceC1585h1.G1(-2, lVar, this.f16256M1);
                lVar.c();
                p2(null);
            } catch (Throwable th) {
                r2(th);
    ...
    public final CharSequence M1(Context context) {
        return D1.P.l(context, C2541R.string.caption_app_kill).o(0, this.packageName).q(this.packageName).f16030c;
    }

    @Override // com.llamalab.automate.A2
    public final boolean r1(C1708z0 c1708z0) {
        c1708z0.q(C2541R.string.stmt_app_kill_title);
