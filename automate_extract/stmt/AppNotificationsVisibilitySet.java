...
@F3.f("app_notifications_visibility_set.html")
@F3.a(C2541R.integer.ic_notification_app)
@F3.i(C2541R.string.stmt_app_notifications_visibility_set_title)
@F3.h(C2541R.string.stmt_app_notifications_visibility_set_summary)
@F3.e(C2541R.layout.stmt_app_notifications_visibility_set_edit)
...
public final class AppNotificationsVisibilitySet extends Action implements AsyncStatement {
    ...
    public static final class a extends AbstractC1602l2 {
        ...
        public final String f16270M1;

        /* renamed from: N1, reason: collision with root package name */
        public final int f16271N1;
    ...
    public final CharSequence M1(Context context) {
        return D1.P.l(context, C2541R.string.caption_app_notifications_visibility_set).o(0, this.packageName).q(this.packageName).e(this.visibility, -1000, C2541R.xml.notification_visibilities_override).q(this.visibility).f16030c;
    }
    ...
    public final boolean r1(C1708z0 c1708z0) {
        c1708z0.q(C2541R.string.stmt_app_notifications_visibility_set_title);
        ...
        c1708z0.w(new a(x7, J3.h.m(c1708z0, this.visibility, -1000)));
        return false;
    }
