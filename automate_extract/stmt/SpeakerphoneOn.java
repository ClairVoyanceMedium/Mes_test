...
@F3.f("speakerphone_on.html")
@F3.a(C2541R.integer.ic_device_access_volume_on)
@F3.i(C2541R.string.stmt_speakerphone_on_title)
@F3.h(C2541R.string.stmt_speakerphone_on_summary)
@F3.e(C2541R.layout.stmt_speakerphone_on_edit)
...
public final class SpeakerphoneOn extends IntermittentDecision implements ReceiverStatement {
    ...
    public static final class a extends AbstractC1618p2.c {
        ...
        public final AudioManager f17150x1;

        /* renamed from: y1, reason: collision with root package name */
        public final boolean f17151y1;

        public a(AudioManager audioManager, boolean z7) {
            this.f17150x1 = audioManager;
            this.f17151y1 = z7;
        }

        @Override // com.llamalab.automate.AbstractC1618p2, android.content.BroadcastReceiver
        public final void onReceive(Context context, Intent intent) {
            boolean isSpeakerphoneOn = this.f17150x1.isSpeakerphoneOn();
            boolean z7 = this.f17151y1;
    ...
    public final CharSequence M1(Context context) {
        ...
        c1596k0.j(this, 0, C2541R.string.caption_speakerphone_on_immediate, C2541R.string.caption_speakerphone_on_change);
